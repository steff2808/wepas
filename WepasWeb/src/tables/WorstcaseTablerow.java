...
public class WorstcaseTablerow implements Cloneable
{
	private static Log log = LogFactory.getLog(WorstcaseTablerow.class);
	...
	private int platz = 0;
	public WorstcaseTablerow(EnTipper tipper, Vector<EnTipp> tipps)
	{
		super();
		this.tipper = tipper;
		this.tipps = tipps;
	...
	@Override
	public WorstcaseTablerow clone()
	{
		WorstcaseTablerow clone = new WorstcaseTablerow(this.tipper, this.tipps);
	...
	public void simulateFirst(Livespiel livespiel)
	{
		...
		{
			throw new RuntimeException("simulateFirst() Vector nicht 1 oder 2!");
		}
