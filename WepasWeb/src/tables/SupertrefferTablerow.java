...
public class SupertrefferTablerow
{
	private static Log log = LogFactory.getLog(SupertrefferTablerow.class);
	...
	public SupertrefferTablerow(EnTipper user, EnTipper tipper, EnTipp tipp, EnSpiel spiel, EnSpieltag spieltag, VereinBeanRemote vereinStateless)
	{
