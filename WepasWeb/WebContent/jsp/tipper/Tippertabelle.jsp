...
<title>Tabelle aus meinen Tipps</title>
</head>

<body>
<form action=<%=response.encodeURL(request.getContextPath() + ApplConstants.JSPTIPPERTABELLE)%> method="post">
<p>Tabelle aus meinen Tipps</p>
<%
...
<%
			...
			out.print(HtmlTags.wrapTD(HtmlTags.createSUBMITdisabled("tippertabelle", "Meine Tabelle", ApplConstants.CSSSUBMIT2), ApplConstants.CSSNOBORDER));
%>		
		</tr>
	</table>
	<br>
