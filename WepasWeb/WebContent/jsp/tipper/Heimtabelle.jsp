...
<title>Bundesliga Heimtabelle</title>
</head>
<body>
<form action=<%=response.encodeURL(request.getContextPath() + ApplConstants.JSPHEIMTABELLE)%>  method="post">
<%
...
//			out.print(HtmlTags.wrapTD(HtmlTags.createSUBMITdisabled("heimtabelle", "Heimtabelle", ApplConstants.CSSSUBMIT2), ApplConstants.CSSNOBORDER));
